...
function act_update(id) {
    ...
    $.ajax({
        ...
        cache: false,
        async: false,
        data: $('#paket-makananForm').serialize(),
        success: function (data) {

            window.location = "paket-makanan.html";
...
function update(id) {
    ...
    $('#paket-makananForm').delay(350).fadeIn("slow");
...
$(document).ready(function () {
    ...
    $.ajax({
        type: 'GET',
        url: rootWebService + '/paket.php?cmd=showlist&jenis=makanan',
        async: true,
