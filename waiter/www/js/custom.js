...
$(window).load(function () { // makes sure the whole site is loaded
    ...
    var link_profile;
    if(level === 'member'){
        link_profile = "profile-member.html";
    }else{
        link_profile = "profile-user.html";
    }
    $('#profile-link').attr('href',link_profile);
    /*
    if (localStorage.getItem('sidebar_status') === 'show') {
...
$(document).ready(function () {
    ...
    $('.show-sidebar').click(function () {
        ...
        $('.hide-sidebar').show();
         //$('#page-sidebar').show();
        //localStorage.setItem('sidebar_status', 'show');
        return false;
    });
    ...
    $('.hide-sidebar').click(function () {
        ...
        //localStorage.setItem('sidebar_status', 'hide');
        return false;
    });
    ...
    $('.show-toggle-v2').click(function () {
        $(this).hide();
        $(this).parent().find('.hide-toggle-v2').show();
    ...
    $('.hide-toggle-v3').click(function () {
        ...
        $(this).hide();
        $(this).parent().find('.toggle-content-v3').fadeIn(200);
        return false;
    });
